...
<div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
  <img src="/assets/duyurular/1.1.jpeg" alt="Bitlis Valiliği ziyareti 1" class="w-full rounded-2xl border border-sand-200 shadow-soft" loading="lazy" decoding="async" />
  <img src="/assets/duyurular/1.2.jpeg" alt="Bitlis Valiliği ziyareti 2" class="w-full rounded-2xl border border-sand-200 shadow-soft" loading="lazy" decoding="async" />
  <img src="/assets/duyurular/1.3.jpeg" alt="Bitlis Valiliği ziyareti 3" class="w-full rounded-2xl border border-sand-200 shadow-soft" loading="lazy" decoding="async" />
  <img src="/assets/duyurular/1.4.jpeg" alt="Bitlis Valiliği ziyareti 4" class="w-full rounded-2xl border border-sand-200 shadow-soft" loading="lazy" decoding="async" />
  <img src="/assets/duyurular/1.5.jpeg" alt="Bitlis Valiliği ziyareti 5" class="w-full rounded-2xl border border-sand-200 shadow-soft" loading="lazy" decoding="async" />
</div>
